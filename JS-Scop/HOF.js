...
function findElementGreaterThenTen(value){
    // if(value > 10){
    //     return true;
    // }
    // return false;
...
// const findElement = list.find(findElementGreaterThenTen);
// const findElement = list.find(function(value){
//     return value > 10;
// });
const findElement = list.find((value) => value > 10);

console.log(findElement);


// function greet(mesaje, transformFunction){
//     console.log(transformFunction(mesaje));
// }
...
// greet("Ciprian", transformUpperCase);
// greet("Ciprian", adunare);